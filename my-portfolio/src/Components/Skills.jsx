...
const Skills = () => {
    return (
<section id="skills"  className="min-h-screen p-5 lg:pt-12 ">
              <h2 className="text-4xl lg:text-5xl font-black text-gray-950 text-center"><span className="py-2 border-b-2 border-teal-500">Skills</span></h2>
<div className="grid lg:grid-cols-3 gap-8">
    {/* front end skills  */}
<div data-aos="fade-up" className="w-full max-w-xl  mx-auto p-4 mt-16">
{/* Skills Title */}
<h4 className="text-3xl md:text-4xl dark:text-white text-teal-700 font-bold mb-6">FrontEnd</h4>
{/* HTML */}
<div className="mb-7">
...
{/* backend skills  */}
<div data-aos="fade-down" className="w-full max-w-xl  mx-auto p-4 mt-16">

{/* Skills Title */}
<h4 className="text-3xl md:text-4xl dark:text-white font-bold mb-6">Backend</h4>
{/* node js */}
<div className="mb-7">
  <div className="flex justify-between py-1">
  ...
  <svg className="rc-progress-line" viewBox="0 0 100 1" preserveAspectRatio="none">
    <path className="rc-progress-line-trail" d="M 0.5,0.5 L 99.5,0.5" strokeLinecap="round" stroke="#D9D9D9" strokeWidth="1" fillOpacity="0"></path>
    <path className="rc-progress-line-path" d="M 0.5,0.5 L 99.5,0.5" strokeLinecap="round" stroke="#68A063" strokeWidth="1" fillOpacity="0" style={{ strokeDasharray: '74.2px, 100px', strokeDashoffset: '0px', transition: 'stroke-dashoffset 0.3s ease 0s, stroke-dasharray 0.3s ease 0s, stroke 0.3s linear 0s, 0.06s' }}></path>
  </svg>
</div>
...
<div className="mb-7">
  <div className="flex justify-between py-1">
    <span className="text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Express Js</span>
    <span className="text-base font-semibold text-gray-lite pr-5 dark:text-[#A6A6A6]">70%</span>
  </div>
  <svg className="rc-progress-line" viewBox="0 0 100 1" preserveAspectRatio="none">
    <path className="rc-progress-line-trail" d="M 0.5,0.5 L 99.5,0.5" strokeLinecap="round" stroke="#D9D9D9" strokeWidth="1" fillOpacity="0"></path>
    <path className="rc-progress-line-path" d="M 0.5,0.5 L 99.5,0.5" strokeLinecap="round" stroke="#000" strokeWidth="1" fillOpacity="0" style={{ strokeDasharray: '69.2px, 100px', strokeDashoffset: '0px', transition: 'stroke-dashoffset 0.3s ease 0s, stroke-dasharray 0.3s ease 0s, stroke 0.3s linear 0s, 0.06s' }}></path>
  </svg>
</div>
{/* mongo db  */}
<div className="mb-7">
...
{/* Skills Title */}
<h4 className="text-3xl md:text-4xl text-neutral-800 dark:text-white font-bold mb-6">Others</h4>
